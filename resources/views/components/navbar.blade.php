    ...
    <div class="flex justify-between items-center h-16">
      ...
      <div class="flex items-center gap-3 sm:gap-4">
        ...
        @php
            ...
            $switchText = $currentLocale === 'ar' ? 'English' : 'عربي';
        @endphp
        <a href="{{ url('lang/' . $switchLocale) }}" class="text-sm font-bold text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
            {{ $switchText }}
        </a>
